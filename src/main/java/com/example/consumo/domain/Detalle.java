...
public String getConsumoNombre(){ return "Consumo";}
    ...
    public String getAjusteAnt(){ return "Ajuste para facilitar el pago en efectivo, mes anterior";}

    public String getAjusteAct(){ return "Ajuste para facilitar el pago en efectivo, mes actual";}
